...
OrderCartCard.propTypes = {
  item: PropTypes.shape({
    image: PropTypes.string.isRequired,        // URL of product image
    name: PropTypes.string.isRequired,         // Product name
    brand: PropTypes.string.isRequired,        // Brand name
    minQty: PropTypes.oneOfType([               // Minimum order quantity (number or string)
      PropTypes.number,
      PropTypes.string,
    ]).isRequired,
    unit: PropTypes.string.isRequired,         // Unit of measurement
    pricePerUnit: PropTypes.number.isRequired, // Price per unit
    qty: PropTypes.oneOfType([                 // Ordered quantity (number or string)
      PropTypes.number,
      PropTypes.string,
    ]).isRequired,
    currentPrice: PropTypes.number.isRequired, // Current total price
  }).isRequired,
};
