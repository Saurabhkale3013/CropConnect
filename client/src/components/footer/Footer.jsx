  ...
  return (
    <>
      <footer className="bg-red-900 text-white h-12 px-4 md:px-12 text-center flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row text-lg md:text-2xl gap-3 md:gap-5">
          <a href={"https://github.com/Saurabhkale3013"} target="_blank" rel="noopener noreferrer">
            <FaGithub />
          </a>
          <a href={"https://www.linkedin.com/in/saurabh-kale-1082b21a5/"} target="_blank" rel="noopener noreferrer">
            <FaLinkedinIn />
          </a>
