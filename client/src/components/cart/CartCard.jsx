...
CartCard.propTypes = {
  item: PropTypes.shape({
    _id: PropTypes.string.isRequired, // Ensures _id is a required string
    ...
    currentPrice: PropTypes.number.isRequired, // Ensures currentPrice is a required number
    brand: PropTypes.string.isRequired, // Ensures brand is a required string
    qty: PropTypes.number.isRequired, // Ensures qty is a required number
    unit: PropTypes.string.isRequired, // Ensures unit is a required string
  }).isRequired, // item is a required object that conforms to the above shape
};
