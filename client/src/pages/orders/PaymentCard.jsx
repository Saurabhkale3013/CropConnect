...
PaymentCard.propTypes = {
  totalAmount: PropTypes.number.isRequired, // Total amount of the order
  limitForFreeDelivery: PropTypes.number.isRequired, // The limit above which delivery is free
  deliveryCharge: PropTypes.number.isRequired, // Delivery charge for the order
  customerLatitude: PropTypes.number, // Latitude of the customer's location
  customerLongitude: PropTypes.number, // Longitude of the customer's location
};
