...
CustomerLocationSelector.propTypes = {
  customerLatitude: PropTypes.number.isRequired, // Latitude for the customer
  customerLongitude: PropTypes.number.isRequired, // Longitude for the customer
  setCustomerLatitude: PropTypes.func.isRequired, // Function to update the customer's latitude
  setCustomerLongitude: PropTypes.func.isRequired, // Function to update the customer's longitude
};
