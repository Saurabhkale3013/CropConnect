...
OrderSummary.propTypes = {
  totalAmount: PropTypes.number.isRequired, // The total amount of the order
  deliveryCharge: PropTypes.number.isRequired, // Delivery charge for the order
  limitForFreeDelivery: PropTypes.number.isRequired, // Limit above which delivery is free
};
