...
SellerFAQs.propTypes = {
  getSellerFAQs: PropTypes.func.isRequired, // Function to fetch FAQs
  ansFAQ: PropTypes.func.isRequired, // Function to answer FAQ
  isLoading: PropTypes.bool.isRequired, // Loading state for FAQ fetching
};
